...
import { AnimatedBeam } from "@/components/AnimatedBeam/animated-beam";
...
export default function AnimatedBeamDemo() {
   ...
   return (
      <div
         className="relative flex justify-center items-center p-10 w-full h-[500px] bg-background md:shadow-xl border rounded-lg overflow-hidden"
         ref={containerRef}
      >
         <div className="flex flex-col justify-between items-stretch gap-10 max-w-lg max-h-[200px] size-full">
