...
const ScrambledTitle: React.FC = () => {
  ...
  return (
    <h1 
      ref={elementRef}
      className="justify-center font-bold text-6xl text-white tracking-wider"
...
const RainingLetters: React.FC = () => {
  ...
  return (
    <div className="relative w-full h-screen bg-black overflow-hidden">
      {/* Title */}
      <div className="top-1/2 left-1/2 z-20 absolute transform -translate-x-1/2 -translate-y-1/2">
        <ScrambledTitle />
      </div>
